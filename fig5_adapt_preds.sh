...
srun --exclusive -N1 -n1 python fig5_adapt_preds.py --model resnet18 --outpath $WORKING_PATH &
srun --exclusive -N1 -n1 python fig5_adapt_preds.py --model alexnet --outpath $WORKING_PATH &
srun --exclusive -N1 -n1 python fig5_adapt_preds.py --model vgg16 --outpath $WORKING_PATH &
srun --exclusive -N1 -n1 python fig5_adapt_preds.py --model vitl32 --outpath $WORKING_PATH &
srun --exclusive -N1 -n1 python fig5_adapt_preds.py --model simclr_resnet50 --outpath $WORKING_PATH &
